<x-blogger::layouts.admin>
  ...
  {!! Form::open(['action' => ['Gmattworld\Blogger\Http\Controllers\BloggerAdminController@store'], 'files'=>true, 'class'=>'forms-sample', 'method'=>'POST']) !!}
    ...
    <div class="max-w-4xl px-5 mx-auto 2xl:max-w-7xl" x-data="app()">
      <div class="flex items-center justify-between w-full mb-5">
        ...
        <div>
          ...
          <span class="mx-1 text-sm text-gray-400 capitalize cursor-pointer">Create Post</span>
        </div>
      </div>
      <div class="flex items-stretch gap-5">
        <div class="flex-auto w-full h-full py-5">
          ...
          <div class="bg-white rounded shadow ">
            {!! Form::textarea('body', '', ['class'=>'w-full h-full', 'id'=>'editor', 'placeholder'=>' What is on your mind?']) !!}
        ...
        <div class="flex-auto w-2/5 h-full mt-5 bg-white">
          <div class="px-3 py-4">
            <div class="text-center">
              <div class="relative w-full mx-auto mb-4 bg-gray-100 border shadow-inset">
                <img id="image" class="object-cover w-full rounded" :src="image" />
              </div>
              <label
                for="fileInput"
                type="button"
          ...
          <div class="px-3 py-2">
            ...
            {!! Form::textarea('brief', '', ['class'=>'w-full h-56 p-3 rounded form-textarea focus:outline-none ring-1 ring-gray-500', 'required'=>'required', 'row'=>'4', 'placeholder'=>' short brief']) !!}
            <span class="text-danger"> {!! $errors->first('brief'); !!} </span>
          </div>
          <div class="px-3 py-2">
            {!! Form::label('category', 'Category', ['class'=>'']) !!}
            {!! Form::text('category', '', ['class'=>'w-full px-3 py-2 border-transparent rounded form-input focus:outline-none ring-1 ring-gray-500', 'required'=>'required', 'placeholder'=>' Category 1, Category 2']) !!}
...
{{--
  ...
  @push('scripts')
    ...
    <script src='https://cdn.tiny.cloud/1/jwr7bpwai996ukv47wjdfwjdkrb91atbfo7215ioi6h44ndb/tinymce/5/tinymce.min.js' referrerpolicy="origin"></script>
    <script>
