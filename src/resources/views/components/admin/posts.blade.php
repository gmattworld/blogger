...
@else
  <div class="w-full h-full mt-32">
    ...
    <p class="text-center">No blog post has been created yet. Click <a class="px-2 py-0.5 rounded text-white bg-gray-700" href="{{ url('/admin/blogger/create') }}">here</a> to create one.</p>
  </div>
@endif
